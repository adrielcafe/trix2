...
import trix2.models.trix.Network;
...
public interface NetworkRepository extends JpaRepository<Network, Integer>,
	...
	Network findByTenantSubdomain(@Param("tenantSubdomain") String tenantSubdomain);

	@RestResource(exported = false)
	Network findByDomain(@Param("domain") String domain);

	@RestResource(exported = false)
	@Query("select n.id, n.domain, n.tenantSubdomain from Network n")
	List<Object[]> findIdsAndDomain();

	@Override
	@RestResource(exported = true)
	@CacheEvict(value = "network", key = "#p0.tenantSubdomain")
