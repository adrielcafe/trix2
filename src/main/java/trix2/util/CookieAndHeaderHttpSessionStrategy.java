 ...
 * {@link CookieAndHeaderHttpSessionStrategy#setCookieName(String)}. The default is
 * "SESSION".
 *
 ...
 * @author Rob Winch
 */
public final class CookieAndHeaderHttpSessionStrategy implements MultiHttpSessionStrategy, HttpSessionManager {
	private static final String SESSION_IDS_WRITTEN_ATTR = CookieAndHeaderHttpSessionStrategy.class.getName().concat(".SESSIONS_WRITTEN_ATTR");
	...
	class MultiSessionHttpServletResponse extends HttpServletResponseWrapper {
		...
		public String encodeRedirectURL(String url) {
			...
			return CookieAndHeaderHttpSessionStrategy.this.encodeURL(url, getCurrentSessionAlias(request));
		}
