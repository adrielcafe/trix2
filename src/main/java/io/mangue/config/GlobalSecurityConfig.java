...
import io.mangue.config.security.BitMaskPermissionGrantingStrategy;
import io.mangue.config.security.MultitenantAclConfig;
import io.mangue.config.security.Permissions;
...
//		daoProvider.setSaltSource(saltSource);
	...
	public MutableAclService aclService(DataSource dataSource, RedisConnectionFactory redisConnectionFactory) throws CacheException, IOException {
		MultitenantAclConfig aclService = new MultitenantAclConfig(dataSource,
