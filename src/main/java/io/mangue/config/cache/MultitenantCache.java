package io.mangue.config.cache;

import io.mangue.config.multitenance.TenantContextHolder;
import io.mangue.exceptions.TargetLookupFailureException;
 ...
 * keys into a tenant-context-specific key using {@link io.mangue.config.multitenance.TenantContextHolder}.  The nuts and bolts of the
...
public final class MultitenantCache implements Cache {
	...
	private String translateKey(Object key) throws TargetLookupFailureException {
		...
		String tenantContext = TenantContextHolder.getTenantSubdomain();
