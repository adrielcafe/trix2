...
import io.mangue.config.database.RepositoryFactoryBean;
import io.mangue.config.flyway.FlywayIntegrator;
import io.mangue.config.multitenance.MultiTenantHibernatePersistence;
