...
import io.mangue.models.custom.Versionable;
...
@FilterDefs({
		@FilterDef(
				name = "tenantFilter",
				parameters = @ParamDef(name = "tenantSubdomain", type = "string")
		),
		@FilterDef(
				name = "idFilter",
...
@Filters({
		@Filter(name = "tenantFilter", condition = "tenantSubdomain = :tenantSubdomain"),
