    ...
    function ($q, uiGridExporterConstants, gridUtil, $compile, $interval, i18nService) {
      ...
      var service = {
        ...
        */
         ...
         * @methodOf  ui.grid.exporter.service:uiGridExporterService
         * @description Determines the column widths custom on the
         ...
         * numeric columns and call this the custom gridwidth.
         *
         * To that we add 100 for any '*' column, and x% of the custom gridWidth
